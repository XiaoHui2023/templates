...
env.emmc_agent.sqr.phase_debug_test(.addr(0), .count(2));
...
| test | `rw_test()`、`phase_debug_test()`、`reg_test()`、`speed_mode_test()`、eMMC `tune_test(data_width = 8)`、`check_clock_frequence_test()` |
